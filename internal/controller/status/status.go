...
import (
	...
	"github.com/dana-team/axiom-operator/internal/controller/utils"
	"github.com/go-logr/logr"
	"reflect"
	"sigs.k8s.io/controller-runtime/pkg/client"
)

func Update(ctx context.Context, logger logr.Logger, clusterInfo v1alpha1.ClusterInfo, k8sClient client.Client) error {
	updatedStatus, err := collectClusterInfo(ctx, logger, k8sClient)
	if err != nil {
		return err
	}
	return utils.RetryOnConflictUpdate(ctx, &clusterInfo, k8sClient, clusterInfo.Name, clusterInfo.Namespace, func(obj *v1alpha1.ClusterInfo) error {
